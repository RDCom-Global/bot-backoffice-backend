...
def lambda_handler(event, context):
    ...
    output = [{"pat_id": row[0],"pat_name": row[1],"sym_id": row[2],"sym_hpo": row[3],"sym_name": row[4],"username": row[5],"link": row[6],"important": row[7],"frequency": row[8]} for row in results]
